package IO::K8s::PrometheusOperator::V1alpha1::LinodeSDConfig;
# ABSTRACT: LinodeSDConfig configurations allow retrieving scrape targets from Linode's Linode APIv4.
our $VERSION = '1.108';
use IO::K8s::Resource;
