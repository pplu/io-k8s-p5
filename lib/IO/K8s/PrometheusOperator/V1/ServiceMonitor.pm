package IO::K8s::PrometheusOperator::V1::ServiceMonitor;
# ABSTRACT: The `ServiceMonitor` custom resource definition (CRD) defines how `Prometheus` and `PrometheusAgent` can scrape metrics from a group of services.
our $VERSION = '1.108';
