...
k8s maxSkew                  => Int, { required => 'schema' };
k8s minDomains               => Int;
k8s nodeAffinityPolicy       => Str;
k8s nodeTaintsPolicy         => Str;
k8s topologyKey              => Str, { required => 'schema' };
k8s whenUnsatisfiable        => Str, { required => 'schema' };

=attr additionalLabelSelectors
