package IO::K8s::Cilium::V2::CiliumBGPPeerConfigSpec;
...
k8s families        => ['+IO::K8s::Cilium::V2::CiliumBGPFamilyWithAdverts'];
k8s gracefulRestart => '+IO::K8s::Cilium::V2::CiliumBGPNeighborGracefulRestart';
k8s timers          => '+IO::K8s::Cilium::V2::CiliumBGPTimers';
k8s transport       => '+IO::K8s::Cilium::V2::CiliumBGPTransport';
