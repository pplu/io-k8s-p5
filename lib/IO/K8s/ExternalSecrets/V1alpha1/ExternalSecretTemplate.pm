package IO::K8s::ExternalSecrets::V1alpha1::ExternalSecretTemplate;
...
k8s metadata      => '+IO::K8s::ExternalSecrets::V1alpha1::ExternalSecretTemplateMetadata';
k8s templateFrom  => ['+IO::K8s::ExternalSecrets::V1alpha1::TemplateFrom'];
k8s type          => Str;
