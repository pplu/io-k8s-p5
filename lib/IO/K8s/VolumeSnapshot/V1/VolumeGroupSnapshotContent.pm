package IO::K8s::VolumeSnapshot::V1::VolumeGroupSnapshotContent;
...
k8s spec => '+IO::K8s::VolumeSnapshot::V1::VolumeGroupSnapshotContentSpec', { required => 'schema' };
...
k8s status => '+IO::K8s::VolumeSnapshot::V1::VolumeGroupSnapshotContentStatus';
