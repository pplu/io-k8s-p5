package IO::K8s::VolumeSnapshot::V1beta2::VolumeGroupSnapshotContentSpec;
...
k8s source => '+IO::K8s::VolumeSnapshot::V1beta2::VolumeGroupSnapshotContentSource', { required => 'schema' };
