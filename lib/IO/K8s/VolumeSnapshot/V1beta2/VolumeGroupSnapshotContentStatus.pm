package IO::K8s::VolumeSnapshot::V1beta2::VolumeGroupSnapshotContentStatus;
...
k8s volumeSnapshotInfoList => ['+IO::K8s::VolumeSnapshot::V1beta2::VolumeSnapshotInfo'];

=attr volumeSnapshotInfoList
