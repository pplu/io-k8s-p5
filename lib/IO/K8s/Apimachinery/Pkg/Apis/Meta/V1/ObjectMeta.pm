...
k8s deletionGracePeriodSeconds => Int;

=attr deletionGracePeriodSeconds
...
k8s managedFields => ['Meta::V1::ManagedFieldsEntry'];
...
k8s ownerReferences => ['Meta::V1::OwnerReference'];

=attr ownerReferences
