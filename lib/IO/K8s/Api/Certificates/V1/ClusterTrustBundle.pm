...
k8s spec => 'Certificates::V1::ClusterTrustBundleSpec', 'required';
...
L<https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#clustertrustbundle-v1-certificates.k8s.io>
