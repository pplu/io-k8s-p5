...
k8s matchConditions => ['Admissionregistration::V1beta1::MatchCondition'];
...
k8s matchConstraints => 'Admissionregistration::V1beta1::MatchResources';
...
k8s paramKind => 'Admissionregistration::V1beta1::ParamKind';
...
k8s validations => ['Admissionregistration::V1beta1::Validation'];
...
k8s variables => ['Admissionregistration::V1beta1::Variable'];
