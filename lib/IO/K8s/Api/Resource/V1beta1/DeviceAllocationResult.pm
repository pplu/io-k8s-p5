package IO::K8s::Api::Resource::V1beta1::DeviceAllocationResult;
# ABSTRACT: DeviceAllocationResult is the result of allocating devices.
our $VERSION = '1.106';
use IO::K8s::Resource;

k8s config => ['Resource::V1beta1::DeviceAllocationConfiguration'];
...
k8s results => ['Resource::V1beta1::DeviceRequestAllocationResult'];
