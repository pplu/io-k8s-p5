...
k8s attributes => { 'Resource::V1beta1::DeviceAttribute' => 1 };
...
k8s capacity => { 'Resource::V1beta1::DeviceCapacity' => 1 };
...
k8s consumesCounters => ['Resource::V1beta1::DeviceCounterConsumption'];
...
k8s taints => ['Resource::V1beta1::DeviceTaint'];
