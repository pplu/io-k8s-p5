...
k8s spec => 'Resource::V1beta1::ResourceClaimTemplateSpec', 'required';
...
L<https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#resourceclaimtemplate-v1beta1-resource.k8s.io>
