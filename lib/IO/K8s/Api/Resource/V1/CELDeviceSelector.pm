package IO::K8s::Api::Resource::V1::CELDeviceSelector;
...
=item * allowMultipleAllocations (bool): the allowMultipleAllocations property of the device (v1.34+ with the DRAConsumableCapacity feature enabled).
