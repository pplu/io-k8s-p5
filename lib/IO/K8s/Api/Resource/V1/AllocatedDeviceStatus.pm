...
Conditions contains the latest observation of the device's state. If the device has been configured according to the class and claim config references, the C<Ready> condition should be True.
...
k8s networkData => 'Resource::V1::NetworkDeviceData';
