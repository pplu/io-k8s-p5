package IO::K8s::Api::Resource::V1beta2::DeviceClass;
...
k8s spec => 'Resource::V1beta2::DeviceClassSpec', 'required';
...
L<https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#deviceclass-v1beta2-resource.k8s.io>
