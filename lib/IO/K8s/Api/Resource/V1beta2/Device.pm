...
k8s attributes => { 'Resource::V1beta2::DeviceAttribute' => 1 };
...
k8s capacity => { 'Resource::V1beta2::DeviceCapacity' => 1 };
...
k8s consumesCounters => ['Resource::V1beta2::DeviceCounterConsumption'];

=attr consumesCounters
...
k8s nodeAllocatableResourceMappings => { 'Resource::V1beta2::NodeAllocatableResourceMapping' => 1 };
...
k8s nodeAllocatableResources => { 'Resource::V1beta2::NodeAllocatableResource' => 1 };
...
k8s taints => ['Resource::V1beta2::DeviceTaint'];
