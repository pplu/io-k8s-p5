package IO::K8s::Api::Resource::V1beta2::ResourceSlice;
...
k8s spec => 'Resource::V1beta2::ResourceSliceSpec', 'required';
...
L<https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.37/#resourceslice-v1beta2-resource.k8s.io>
