package IO::K8s::Api::Resource::V1beta2::NodeAllocatableResource;
...
k8s mapping => 'Resource::V1beta2::NodeAllocatableMapping';
...
k8s overhead => 'Resource::V1beta2::NodeAllocatableOverhead';
