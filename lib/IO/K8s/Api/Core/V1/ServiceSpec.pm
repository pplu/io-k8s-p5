...
k8s healthCheckNodePort => Int;

=attr healthCheckNodePort
...
k8s internalTrafficPolicy => Str;

=attr internalTrafficPolicy
...
k8s publishNotReadyAddresses => Bool;

=attr publishNotReadyAddresses
...
k8s sessionAffinity => Str;

=attr sessionAffinity

Supports "ClientIP" and "None". Used to maintain session affinity. Enable client IP based session affinity. Must be ClientIP or None. Defaults to None. More info: https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies

=cut

k8s sessionAffinityConfig => 'Core::V1::SessionAffinityConfig';

=attr sessionAffinityConfig
