...
k8s maxFailedIndexes => Int;

=attr maxFailedIndexes
...
k8s podFailurePolicy => 'Batch::V1::PodFailurePolicy';

=attr podFailurePolicy
...
k8s successPolicy => 'Batch::V1::SuccessPolicy';
...
k8s ttlSecondsAfterFinished => Int;
