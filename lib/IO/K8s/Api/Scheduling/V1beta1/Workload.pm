package IO::K8s::Api::Scheduling::V1beta1::Workload;
...
k8s spec => 'Scheduling::V1beta1::WorkloadSpec', 'required';
...
L<https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.36/#workload-v1beta1-scheduling.k8s.io>
