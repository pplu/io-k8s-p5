package IO::K8s::GatewayAPI::V1beta1::SecretObjectReference;
# ABSTRACT: ClientCertificateRef references an object that contains a client certificate and its associated private key.
our $VERSION = '1.108';
use IO::K8s::Resource;
