...
k8s allowedListeners => '+IO::K8s::GatewayAPI::V1beta1::AllowedListeners';
k8s gatewayClassName => Str, { required => 'schema' };
k8s infrastructure   => '+IO::K8s::GatewayAPI::V1beta1::GatewayInfrastructure';
k8s listeners        => ['+IO::K8s::GatewayAPI::V1beta1::Listener'], { required => 'schema' };
k8s tls              => '+IO::K8s::GatewayAPI::V1beta1::GatewayTLSConfig';
